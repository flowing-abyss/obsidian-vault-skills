...
description: 'Transform text content into professional Mermaid diagrams for Obsidian and GitHub. Supports flowcharts, mindmaps, sequence diagrams, state diagrams, comparisons, and more with built-in syntax error prevention. INVOKE when user wants a Mermaid diagram or code block. Triggers: "mermaid", "mermaid diagram", "visualize as mermaid", "sequence diagram", "state diagram", "mermaid схема", "визуализируй как mermaid", "создай mermaid диаграмму".'
---
